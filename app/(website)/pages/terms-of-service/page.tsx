    ...
    <main>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto space-y-4 text-sm leading-relaxed">
          ...
          <p>
            This website is operated by Sero Beverage Co. Throughout the site,
            the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer
            to Sero Beverage Co. Sero Beverage Co offers this website, including
      ...
      <section className="bg-primary-semilight/30 py-12 px-6">
        <div className="max-w-4xl mx-auto space-y-10 text-sm leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <p>
              In no case shall Sero Beverage Co, our directors, officers,
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto space-y-10 text-sm leading-relaxed">
          <div className="space-y-3">
            ...
            <p>
              You agree to indemnify, defend and hold harmless Sero Beverage Co
      ...
      {/* Contact */}
      <section className="relative bg-linear-to-b from-primary-semilight to-background py-16 px-6">
